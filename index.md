...
<body>
    <head>
        <meta charset="utf-8">
        <title>Caletas - Guía para ver páginas bloqueadas.</title>
 ...
 -->        <!-- Loading Custom CSS -->
  ...
  <header>
    ...
    <div class="caleta-head">

        <a href="index.html"><img class="caleta-logo" src="images/logo.png" alt="Logo Caletas">
        <p class="caleta-tagline">El conocimiento es libertad; accede a ambos.</p>
    </div>

    <!-- Explicación -->

    <div class="explicacion">
        <p>Ver páginas bloqueadas es más fácil de lo que crees.<br>Te damos 4 opciones que van de simple a menos simple.<br>Si no te sirve una, intenta con la siguiente.</p>

    </div>

</header>
<nav class="nav-caletas">
    <ul class="ul-menu">
        <li class="li-menu"><a class="link-menu" href="#1">1. GOOGLE</a></li>
        <li class="li-menu"><a class="link-menu" href="#2">2. DNS</a></li>
        <li class="li-menu"><a class="link-menu" href="#3">3. VPN</a></li>
        <li class="li-menu"><a class="link-menu" href="#4">4. TOR</a></li>
        <li class="li-menu"><a class="link-menu" href="#5">5. MENSAJEROS</a></li>
    </ul>
</nav>
...
<div class="secciones">
    ...
    <p>Si tienen alguna duda de cómo configurar algo, la pueden dejar aquí también.</p>

    <div id="disqus_thread"></div>
    <script type="text/javascript">
        /* * * CONFIGURATION VARIABLES: EDIT BEFORE PASTING INTO YOUR WEBPAGE * * */
        var disqus_shortname = 'caletas'; // required: replace example with your forum shortname
...
<div class="footer">
    <p>
        Actualizamos frecuentemente.
    </p>

    <p>
        Ninguna tecnología es 100% segura, usa el sentido común.
    </p>
</div>
...
<script>
  ...
  ga('create', 'UA-48119725-1', 'caletas.github.io');
  ga('send', 'pageview');
